...
class OpenGL extends GLJPanel implements GLEventListener, KeyListener{
    ...
    private void draw(GL2 gl2) {
        ...
        if (objectNumber ==1) {             //korkociąg
            ...
            //glut.glutWireTorus(1,4,100,100);
    ...
    public void Corksrew(GL2 gl2,int radius, int numberOfTurns){
        ...
        int numVertices = numberOfTurns*1000;
