...
public class TransformedShapes extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		Shape circle = new Ellipse2D.Double(150, 150, 300, 300);
		g2.setColor(getForeground().BLACK);
		g2.fill(circle);
		g2.draw(circle);
		
		Shape rect = new Rectangle(225, 225, 150, 150);
		g2.setColor(getForeground().YELLOW);
		g2.fill(rect);
		g2.draw(rect);
