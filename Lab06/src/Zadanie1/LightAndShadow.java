 ...
 */
class LightAndShadow extends GLJPanel implements GLEventListener  {
    ...
    public static void main(String[] args) {
        ...
        LightAndShadow panel = new LightAndShadow();
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl2.glLoadIdentity();
        glu.gluLookAt( 0,5,40, 0,1,0, 0,1,0 );  // viewing transform
    ...
    private class MouseHandler extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent evt) {
            ...
            prevX = evt.getX();
            dragging = true;
            LightAndShadow.this.addMouseMotionListener(this);
        }
        public void mouseReleased(MouseEvent evt) {
            dragging = false;
            LightAndShadow.this.removeMouseMotionListener(this);
        }
